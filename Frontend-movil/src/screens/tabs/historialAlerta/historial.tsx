...
import { View, Text, FlatList, Image, TextInput, RefreshControl, TouchableOpacity } from "react-native";
import { createStyles, getEmergenciaColors, getAsistenciaColors } from "./historial.style";
